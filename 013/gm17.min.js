...
function Press(e) {
	...
	case 0:
		e = e.y / wdpr | 0;
        var kx = canvas.clientWidth/320;
        var ky = canvas.clientHeight/416;
        t /= kx;e /= ky;
		//175 < t && 365 < e ? window.location.href = HOME_PATH:
        60 > t && 350 < e ? setTimeout(function() {
			show_share()
		},
	...
	case 2:
		f = e.y / wdpr | 0;
		//175 < t && 365 < f ? window.location.href = HOME_PATH:
        var kx = canvas.clientWidth/320;
        var ky = canvas.clientHeight/416;
        t/=kx;f/=ky;
        35 < t && 280 < f && t < 155 && f < 325 ? (t = scr_m | 0, scr_m = t = 0, stini(), gmstini()) : 168 < t && 280 < f && t < 286 && f < 325 && setTimeout(function() {
			show_share()
		},
		500)
	}
