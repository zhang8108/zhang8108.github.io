				...
				buttons: {
					close: {
						...
						click: function() {
							...
							//shareData.tTitle = "英雄难过美人关第2季！我已通关啦！霸气侧漏！你能过几关？";
							//shareData.tContent = "我已经通关啦！" + (self.currIndex + 1) + "个美人关全过！我才是霸气侧漏慧眼识美人的大英雄，你能过几关？";
						}
					}
				}
			})
			...
			dialog.dialog({
				...
				buttons: {
					confirm: {
						title: "再过一关",
						click: function() {
							//shareData.tTitle = "英雄难过美人关第2季！我已过" + (self.currIndex + 1) + "个美人关，你能过几关？";
							//shareData.tContent = "我已过了" + (self.currIndex + 1) + "个美人关，本关正确率" + self.action.correctPecent + "%,耗时" + self.second + "秒!";
		...
		dialog.dialog({
			...
			buttons: {
				...
				close: {
					title: "炫~耀一下",
					click: function() {
						//shareData.tTitle = "英雄难过美人关第2季！我已过" + self.currIndex + "个美人关，你能过几关？";
						document.title = "英雄难过美人关第2季！我已过" + self.currIndex + "个美人关，你能过几关？";
						//shareData.tContent = "我已过了" + self.currIndex + "个美人关，本关正确率" + self.action.correctPecent + "%,耗时" + self.second + "秒!";
						self.showShare(function() {
							self.currIndex = 0;
							self.gamestart()
						})
