function main() {
	...
	jsGame.pageLoad(function(t) {
        ...
        var KY = 640/document.body.clientHeight;
		var u = {
		...
		t.run(function() {
			...
			a.draw("english", 0, a.isPressed ? 1 : 0, a.w, a.h, a.x, a.y, a.w, a.h);
				...
				"ENG" == P ? (f.draw("startE", 0, f.isPressed ? 1 : 0, f.w, f.h, f.x, f.y, f.w, f.h),
                    (function(){}())//l.draw("moreE", 0, l.isPressed ? 1 : 0, l.w, l.h, l.x, l.y, l.w, l.h)
                    ) : (f.draw("start", 0, f.isPressed ? 1 : 0, f.w, f.h, f.x, f.y, f.w, f.h), (function(){}())
                    //l.draw("more", 0, l.isPressed ? 1 : 0, l.w, l.h, l.x, l.y, l.w, l.h)
            )
			} else if (D == O) j(),
